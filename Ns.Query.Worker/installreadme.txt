...
AS
SELECT     NEWID() AS Id, nrs_am.dbo.NsActionLog.CreatedOn, nrs_am.dbo.NsActionLog.QueryId, nrs_am.dbo.NsActionLog.ClientId, nrs_am.dbo.NsActionLog.DebtId, dbo.NsAction.Name AS ActionType, nrs_am.dbo.NsActionLog.BPName, NULL AS CreatedBy, NULL AS ModifiedOn, NULL 
                  AS ModifiedBy, 0 AS ProcessListeners
FROM        nrs_am.dbo.NsActionLog INNER JOIN
                  dbo.NsAction ON dbo.NsAction.NrsId = nrs_am.dbo.NsActionLog.ActionId
